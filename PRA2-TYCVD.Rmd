...
````{r echo=TRUE, message=FALSE, warning=FALSE}
write.csv(dataset, "train_clean.csv")
````
...
Al estar ante unas varianzas diferentes el estadistico a aplicar será el contraste de dos muestras sobre la media con varianzas diferentes.
...
````{r echo=TRUE, message=FALSE, warning=FALSE}
write.csv(d_test, "test_result.csv")
````
