...
Revisando la presencia de valores vacíos nos encontramos con 177 valores vacíos el a columna de 'Age' por lo que para no entorpecer el análisis posterior aplicaremos el valor de la media de la edad a estos valores nulos.
...
Revisamos los valores extremos que pudieran existir en la variable Age, para ello utilizamos un diagrama de caja
